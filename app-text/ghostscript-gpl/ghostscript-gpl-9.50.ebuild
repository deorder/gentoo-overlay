...
# Deorder: cross: https://github.com/buildroot/buildroot/blob/master/package/ghostscript/ghostscript.mk
...
src_configure() {
	...
	CCAUX="$(tc-getBUILD_CC)" \
	CFLAGSAUX="${BUILD_CFLAGS} ${BUILD_LDFLAGS}" \
