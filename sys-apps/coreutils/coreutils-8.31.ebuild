...
inherit eutils flag-o-matic python-any-r1 toolchain-funcs autotools
...
src_prepare() {
	...
	# Deorder: musl + cross: https://github.com/NixOS/nixpkgs/pull/61250
	eapply "${FILESDIR}/${PN}-8.31-cross-musl.patch"
	...
	# Deorder: cross: Update to use new aclocal
	eautoreconf
}
